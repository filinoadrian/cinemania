...
import com.far_sstrwnt.cinemania.ui.people.PeoplePagingAdapter
...
class SearchPeoplePagerFragment(private val viewModel: NewSearchViewModel) : Fragment() {

    private lateinit var binding: FragmentSearchPagerBinding

    private lateinit var adapter: PeoplePagingAdapter
    ...
    private fun searchPeople(query: String) {
        ...
        searchJob = lifecycleScope.launch {
            viewModel.searchPeople(query).collectLatest {
